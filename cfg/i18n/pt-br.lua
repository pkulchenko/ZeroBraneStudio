...
return {
  ...
  ["Binary file is shown as read-only as it is only partially loaded."] = "Arquivo binário é exibido como somente-leitura, pois ele é apenas carregado parcialmente.", -- src\editor\commands.lua
  ...
  ["Can't process auto-recovery record; invalid format: %s."] = "Impossível processar registro de autorrecuperação; formato inválido: %s.", -- src\editor\commands.lua
  ["Can't replace in read-only text."] = "Impossível substituir em texto somente-leitura.", -- src\editor\findreplace.lua
  ["Can't run the entry point script ('%s')."] = "Impossível executar o ponto de entrada do script ('%s').", -- src\editor\debugger.lua
  ["Can't start debugger server at %s:%d: %s."] = "Impossível iniciar o servidor de depuração em %s:%d: %s.", -- src\editor\debugger.lua
  ...
  ["Program unable to run as '%s'."] = "Impossível executar programa como '%s'.", -- src\editor\output.lua
  ...
  ["Refused a request to start a new debugging session as there is one in progress already."] = "Recusada a solicitação de início de uma nova sessão de depuração, pois já há uma em progresso.", -- src\editor\debugger.lua
  ...
  ["Step &Over"] = "Passar p&or cima", -- src\editor\menu_project.lua
  ...
  ["Step over"] = "Passar por cima", -- src\editor\toolbar.lua, src\editor\menu_project.lua
  ...
  ["Unable to create directory '%s'."] = "Impossível criar a pasta '%s'.", -- src\editor\filetree.lua
  ["Unable to create file '%s'."] = "Impossível criar o arquivo '%s'.", -- src\editor\filetree.lua
  ["Unable to delete directory '%s': %s"] = "Impossível apagar a pasta '%s': %s", -- src\editor\filetree.lua
  ["Unable to delete file '%s': %s"] = "Impossível apagar o arquivo '%s': %s", -- src\editor\filetree.lua
