return {
  ...
  ["&Delete"] = "&Löschen", -- src\editor\filetree.lua
  ...
  ["&Getting Started Guide"] = "&Erste Schritte", -- src\editor\menu_help.lua
  ["&Goto Line"] = "&Gehe zu Zeile", -- src\editor\menu_search.lua
  ["&Help"] = "&Hilfe", -- src\editor\menu_help.lua
  ["&New Directory"] = "&Neues Verzeichnis", -- src\editor\filetree.lua
  ...
  ["Cancelled by the user."] = "Abbruch durch Benutzer.", -- src\editor\findreplace.lua
  ...
  ["Consider removing backslash from escape sequence '%s'."] = "Möglicherweise muß '\' von der Escape-Sequenz '%s' entfernt werden.", -- src\editor\commands.lua
  ["Copy Full Path"] = "Kompletten Pfad kopieren", -- src\editor\filetree.lua
  ...
  ["Do you want to delete '%s'?"] = "Wollen Sie '%s' löschen?", -- src\editor\filetree.lua
  ["Do you want to overwrite it?"] = "Wollen Sie überschreiben?", -- src\editor\commands.lua
  ["Do you want to reload it?"] = "Wollen Sie neu laden?", -- src\editor\editor.lua
  ["Do you want to save the changes to '%s'?"] = "Wollen Sie Änderungen an '%s' speichern?", -- src\editor\commands.lua
  ...
  ["Enter command line parameters (use Cancel to clear)"] = "Kommandozeilenparameter eingeben (Esc zum Zurücksetzen)", -- src\editor\menu_project.lua
  ...
  ["Select and Find Next"] = "Auswählen und nächstes Vorkommen finden", -- src\editor\menu_search.lua
  ["Select and Find Previous"] = "Auswählen und voriges Vorkommen finden", -- src\editor\menu_search.lua
  ["Select the word under cursor and find its next occurrence"] = "Wort unter Zeiger auswählen und nächstes Vorkommen finden", -- src\editor\menu_search.lua
  ["Select the word under cursor and find its previous occurrence"] = "Wort unter Zeiger auswählen und voriges Vorkommen finden", -- src\editor\menu_search.lua
  ...
  ["Start or Continue debugging"] = "Debugging starten oder fortsetzen", -- src\editor\gui.lua
  ["Start or continue debugging"] = "Debugging starten oder fortsetzen", -- src\editor\menu_project.lua
  ...
  ["Unable to create directory '%s'."] = "Scheitern beim Erstellen von Verzeichnis '%s'.", -- src\editor\filetree.lua
  ["Unable to create file '%s'."] = "Scheitern beim Erstellen von Datei '%s'.", -- src\editor\filetree.lua
