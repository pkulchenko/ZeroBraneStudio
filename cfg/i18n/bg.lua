return {
  ...
  ["Command Line Parameters..."] = "Командни Паранетри...", -- src\editor\gui.lua, src\editor\menu_project.lua
  ["Command line parameters"] = "Паранетри от командния ред", -- src\editor\menu_project.lua
  ...
  ["Find text in files"] = "Намери следващ във файлове", -- src\editor\menu_search.lua
  ...
  ["Page Setup..."] = "Настройки Страница...", -- src\editor\print.lua
  ...
  ["Use Shift-Enter for multiline code."] = "Използвайте Shift-Enter за многоредов код.", -- src\editor\shellbox.lua
