return {
  ...
  ["Cancelled by the user."] = "由使用者取消", -- src\editor\findreplace.lua
  ...
  ["Clear Bookmarks In File"] = "清除檔案中的書籤", -- src\editor\markers.lua
  ["Clear Bookmarks In Project"] = "清除專案中的書籤", -- src\editor\markers.lua
  ["Clear Breakpoints In File"] = "清除檔案中的斷點", -- src\editor\markers.lua
  ...
  ["Clear items from this list"] = "清除列表中的項目", -- src\editor\menu_file.lua
  ...
  ["Comment or uncomment current or selected lines"] = "切換目前或所選行的註解", -- src\editor\menu_edit.lua
  ...
  ["Compile the current file"] = "編譯目前檔案", -- src\editor\toolbar.lua, src\editor\menu_project.lua
  ...
  ["Error"] = "錯誤", -- src\editor\package.lua
  ...
  ["Fold or unfold all code folds"] = "折疊或伸展所有程式碼", -- src\editor\menu_edit.lua
  ["Fold or unfold current line"] = "折疊或伸展目前行", -- src\editor\menu_edit.lua
  ...
  ["Queued %d files to index."] = "佇列 %d 個檔案到索引", -- src\editor\commandbar.lua
  ...
  ["Searching in '%s'."] = "在 '%s' 中搜尋", -- src\editor\findreplace.lua
  ...
  ["Set As Start File"] = "設定為啟動檔案", -- src\editor\gui.lua, src\editor\filetree.lua
  ...
  ["The API file must be located in a subdirectory of the API directory."] = "API檔必須放在API資料夾的子目錄中", -- src\main.lua
  ...
  ["Unable to create directory '%s'."] = "無法創建目錄 '%s'", -- src\editor\filetree.lua
  ...
  ["Unset '%s' As Start File"] = "取消設定 '%s' 為啟動檔案", -- src\editor\gui.lua, src\editor\filetree.lua
  ...
  ["Use 'clear' to clear the shell output and the history."] = "用 'clear' 清除shell輸出與歷史", -- src\editor\shellbox.lua
  ["Use 'reset' to clear the environment."] = "用 'reset' 清除環境", -- src\editor\shellbox.lua
