...
Note that on Mac OSX the per-system configuration file **may be overwritten** when a new version of ZeroBrane Studio is installed to the `Applications` folder, so you may want to save it before upgrading.
